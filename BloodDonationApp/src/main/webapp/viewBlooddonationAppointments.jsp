...
<head>
    ...
    <title>View Blood Donation Appointments</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <h2>Blood Donation Appointments</h2>
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <%
                    ...
                    ArrayList<Appointment> appointments = dao.getBloodDonationAppointmentsSortedByDate();
